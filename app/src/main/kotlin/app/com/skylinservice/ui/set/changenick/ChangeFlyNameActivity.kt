...
class ChangeFlyNameActivity : BaseActivity(), ChangeNickNameContract.View {
    ...
    override fun showAPIExcpetion(exception: ApiException) {
        if (!exception.isTokenExpried)
            ...
            finishAffinity()
            startActivity(Intent(this@ChangeFlyNameActivity, LoginActivity::class.java))
        }
    }
    ...
    override fun showChangeFly(posts: VlideNumModel, name: String) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_change_fly_name)
        ...
        nickname_edit.text = Editable.Factory.getInstance().newEditable(intent.getStringExtra("name"))
        ...
        toolbar.title = getString(R.string.SettingActivity_tv1)
        ...
        change_nick.setOnClickListener {
            ...
            presenter.changeFly(intent.getStringExtra("_id"), nickname_edit.text.toString())
        }
